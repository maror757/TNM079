...
bool HalfEdgeMesh::AddFace(const std::vector<Vector3<float> > &verts) {
  ...
  size_t he0, he1, he2, pair0, pair1, pair2;
  AddHalfEdgePair(v0, v1, he0, pair0);
  AddHalfEdgePair(v1, v2, he1, pair1);
  AddHalfEdgePair(v2, v0, he2, pair2);
